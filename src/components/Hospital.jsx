...
export default function PatientCheckInSystem() {
    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="flex mb-8 bg-white rounded-lg shadow overflow-hidden">
          ...
          <button
            onClick={() => queueInfo && setActiveTab("arrivalGuide")}
            disabled={!queueInfo}
            className={`flex items-center justify-center px-4 py-3 flex-1 ${
              !queueInfo
                ? "bg-gray-100 text-gray-400 cursor-not-allowed"
                : activeTab === "arrivalGuide"
                ? "bg-blue-600 text-white"
                : "bg-white text-gray-600 hover:bg-blue-50"
            }`}
          >
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
            ...
            <div>
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-8">
                ...
                <div className="mt-6 text-center">
                  <button
                    onClick={() => setActiveTab("arrivalGuide")}
          ...
          {/* Arrival Guide */}
          {activeTab === "arrivalGuide" && queueInfo && (
            <div>
              <h2 className="text-2xl font-bold mb-2">Arrival Guide</h2>
              <p className="text-gray-600 mb-6">For {selectedHospital.name}</p>
              ...
              <div className="mt-8 bg-green-50 border border-green-200 rounded-lg p-4">
                ...
                <p className="text-green-700 mt-1">
                  If you need any help during your visit, please approach any
                  staff member or call the hospital helpline at{" "}
                  <span className="font-medium">030-123-4567</span>.
                </p>
              </div>
            </div>
          )}
      ...
      {/* <footer className="bg-gray-800 text-white py-8 mt-12">
        <div className="container mx-auto px-4">
          <p className="text-center">
            © 2025 pVault Health Platform. All rights reserved.
          </p>
        </div>
      </footer> */}
    </div>
